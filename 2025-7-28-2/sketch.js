...
function drawMinimalComposition() {
  ...
  fill(mainGray, mainGray, mainGray - random(0, 5));
  noStroke();
  ...
  // サブ要素 - ランダムな配置とサイズ
  let subGray = random(60, 75);
  fill(subGray, subGray, subGray + random(0, 10));
  ...
  // アクセント - ランダムな色と配置
  let navyR = random(20, 35);
  let navyG = random(30, 45);
  let navyB = random(45, 65);
  fill(navyR, navyG, navyB);
