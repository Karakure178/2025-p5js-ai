...
function generateYarns() {
  ...
  // 四角形の4つの頂点
  const corners = [
    { x: centerX - halfSize, y: centerY - halfSize }, // 左上
    { x: centerX + halfSize, y: centerY - halfSize }, // 右上
    { x: centerX + halfSize, y: centerY + halfSize }, // 右下
    { x: centerX - halfSize, y: centerY + halfSize }  // 左下
  ];
